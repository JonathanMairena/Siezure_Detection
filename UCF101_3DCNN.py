...
# set path
data_path = ""    # define data direectory path
action_name_path = "" # define file path
save_model_path = "" #Empty dir to save trained modeel too
...
epochs = 2
batch_size = 10   ### Change with increaseing data size 
learning_rate = 1e-4
log_interval = 10
img_x, img_y = 320, 240  # resize video 2d frame size ##### new reduced frame size is 320x240p ######

# Select which frame to begin & end in videos
begin_frame, end_frame, skip_frame = 1, 28, 1 #whatt frames are you looking at
...
def validation(model, device, optimizer, test_loader):
    ...
    test_score = accuracy_score(all_y, all_y_pred)
...
with open(action_name_path, 'rb') as f:
    actions = pickle.load(f)   # load actions
